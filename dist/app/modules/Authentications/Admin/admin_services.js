...
const updateUserBlockedFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const objectId = new mongoose_1.Types.ObjectId(id);
        const result = yield user_model_1.default.updateOne({ _id: objectId }, { $set: { isBlocked: true } });
        return result;
    }
    catch (error) {
